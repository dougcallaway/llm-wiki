...
so the agent can read them directly rather than relying on URLs that may break.
...
**The agent's role on organize:** When reading a source that has image references pointing
